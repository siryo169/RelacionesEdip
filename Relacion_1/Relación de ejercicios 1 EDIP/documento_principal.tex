...
\begin{enumerate}[label=\textit{\alph*})]
   ...
   \right.
    ...
    \begin{enumerate}[label=\textit{\roman*})]
        ...
        \[
            \frac{n}{2} = \frac{500}{2} = 250, \hspace{1cm} N_2 < 250 < N_3 \hspace{1cm} Me = 2 \hspace{0.2cm}hijos
        \]
        
        \item Moda:
        
        \[
            n_3 \geq n_j \hspace{1cm} \forall j \neq 3 \hspace{1cm} Mo = 2 \hspace{0.1cm} hijos
        \]
...
\end{center}
    ...
    \begin{center}
            ...
            \begin{minipage}[h!]{1\linewidth}
            \begin{itemize}
                \item Población: en este caso no se determina cuál es en ninguna de ellas.
...
\begin{enumerate}[label=\textit{\alph*)}]
    ...
    \begin{enumerate}[label=]
        ...
        \begin{enumerate}[label=(\arabic*)]
            ...
            \item \(\overline{x} = \frac{12\cdot0.5 + 13\cdot 1.5 + 11 \cdot 2.5 + 8 \cdot 3.5 + 6 \cdot 4.5}{12+13+11+8+6} = 2.16\)
            
            \item \(\overline{x} = \frac{1 \cdot 0.5 + 6 \cdot 2 + 7 \cdot 4.5 + 12 \cdot 8 + 2 \cdot 11}{1+6+7+12+2} = 5.786\)
        \end{enumerate}
        ...
        \begin{enumerate}[label=(\arabic*)]
            \item \(H = \frac{12+13+11+8+6}{\frac{12}{0.5} + \frac{12}{1.5} + \frac{11}{2.5} + \frac{8}{3.5} + \frac{6}{4.5}} = 1.229\)
            
            \item \(H = \frac{1+6+7+12+2}{\frac{1}{0.5} + \frac{6}{2} + \frac{7}{4.5} + \frac{12}{8} + \frac{2}{11}} = 3.399\)
        \end{enumerate}
